...
/* harmony import */ var _templates_sliders_handlebars__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
...
function deriveAttributes(shipLevels, previous) {
    ...
    var maximumTravelHeight = roundDecimal((150 + Math.pow((shipLevels.voidCoreStrength - 1), 2) * 100 - 50 * Math.log(0.25 * mass)) * feetPerMeter);
...
var _internalProtoAccess = __webpack_require__(19);
...
var _createNewLookupObject = __webpack_require__(20);
...
var _internalWrapHelper = __webpack_require__(23);
